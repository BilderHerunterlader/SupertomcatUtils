...
public final class FileUtil {
	...
	private static class FilenameAsciiOnlyFilter extends FilenameFilter {
		...
		public FilenameAsciiOnlyFilter() {
			...
			patterns.put(Pattern.compile("[ˆ]"), "oe");
			patterns.put(Pattern.compile("[ÚÛÙı]"), "o");
			patterns.put(Pattern.compile("[÷]"), "OE");
			patterns.put(Pattern.compile("[“”‘’]"), "O");

			patterns.put(Pattern.compile("[‰]"), "ae");
			patterns.put(Pattern.compile("[‡·‚„Â]"), "a");
			patterns.put(Pattern.compile("[ƒ]"), "AE");
			patterns.put(Pattern.compile("[¿¡¬√≈]"), "A");

			patterns.put(Pattern.compile("[¸]"), "ue");
			patterns.put(Pattern.compile("[˘˙˚µ]"), "u");
			patterns.put(Pattern.compile("[‹]"), "UE");
			patterns.put(Pattern.compile("[Ÿ⁄€]"), "U");

			patterns.put(Pattern.compile("[ËÈÍÎ]"), "e");
			patterns.put(Pattern.compile("[»… À]"), "E");

			patterns.put(Pattern.compile("[ÏÌÓÔ]"), "i");
			patterns.put(Pattern.compile("[ÃÕŒœ]"), "I");

			patterns.put(Pattern.compile("[ﬂ]"), "ss");
